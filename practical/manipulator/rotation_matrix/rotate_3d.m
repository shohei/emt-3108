...
newvect=R*vect;
plt(1)=plot3(newvect(1,:),newvect(2,:),newvect(3,:),'linewidth',2);
hold on
plt(2)=plot3([-a(1),a(1)],[-a(2),a(2)],[-a(3),a(3)],'r--o','linewidth',2);
hold off
...
set(ui1,'position',[10  85 60 20],'callback','update_orientation');
set(ui2,'position',[10  45 60 20],'callback','update_orientation');
set(ui3,'position',[10  25 60 20],'callback','update_orientation');
set(ui4,'position',[10   5 60 20],'callback','update_orientation');
